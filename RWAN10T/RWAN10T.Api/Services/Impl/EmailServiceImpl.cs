...
public class EmailServiceImpl(EmailSender emailSender, ILogger<EmailServiceImpl> logger) : IEmailService
{
    private readonly EmailSender _emailSender = emailSender;
    private readonly ILogger<EmailServiceImpl> _logger = logger;
